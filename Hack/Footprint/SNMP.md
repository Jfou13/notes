...
```bash
Jfou@htb[/htb]$ snmpwalk -v2c -c public 10.129.14.128
...
```bash
Jfou@htb[/htb]$ sudo apt install onesixtyone
Jfou@htb[/htb]$ onesixtyone -c /opt/useful/seclists/Discovery/SNMP/snmp.txt 10.129.14.128
...
```bash
Jfou@htb[/htb]$ sudo apt install braa
Jfou@htb[/htb]$ braa <community string>@<IP>:.1.3.6.*   # Syntaxe
Jfou@htb[/htb]$ braa public@10.129.14.128:.1.3.6.*
